# Style guide for Lab Data dan Komputasi Geoteknik Publications
...
- Use one pair of double asterisks when multiple Lab Data dan Komputasi Geoteknik members appear sequentially: **Apoji D, Hermawan A**
...
authors: "**Surname FM**, Surname FM, **Apoji D**"
...
pmid: #"########"
pmcid: #"PMC#######"
link: #"https://scholar.google.com/citations?view_op=view_citation&hl=en&citation_for_view=XXXXXXXXXXXX:YYYYYYYYYY"
biorxiv: "YYYY.MM.DD.######"
pdf: #"</static/pdf/YYYY_SurnameFirstAuthor.pdf>" #Upload PDF of journal article to ensure open access
pdbs:
...
github:
- url: #"org-name/repo-name"
    description: #"qPTxM v3.0"
links:
- name: "Fujimori lab @ UC San Francisco"
    url: "<https://collaborator-lab.example.edu>"
